            ...
            <nav className='navbar'>
                <div className='navbar-container'>
                    ...
                    <ul className={click ? 'nav-menu active' : 'nav-menu'}>
                        ...
                        <Link to={`${SUB_DOMAIN}/`} className='nav-links' onClick={closeMenu}>Home</Link>
                        </li>
                        <li className='nav-item'>
                        <Link to={`${SUB_DOMAIN}/detailsProduct`} className='nav-links' onClick={closeMenu}>Menu</Link>
                        </li>
                        <li className='nav-item'>
                        <Link
                            to={`${SUB_DOMAIN}/services`}
                            className='nav-links'
                            onClick={closeMenu}
                        >Services</Link>
                        </li>
                        <li className='nav-item'>
                        <Link 
                            to={`${SUB_DOMAIN}/contact`}
                            className='nav-links'
                            onClick={closeMenu}
                        >Contact</Link>
                        </li>
                        <li className="nav-item">
                        <Link to={`${SUB_DOMAIN}/login`} className="nav-links-sign">
